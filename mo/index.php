<? include "../config/core.php";
   ...
   $whatsapp = 'https://wa.me/77759717159';
   $wh_txt1 = 'Хочу купить курс ..';
   ...
   <div class="blo1">
      <div class="bl_c">
         <div class="blo1_c">
            ...
            <div class="blo1_t">
               <h1 class="blo1_tof">Станьте востребованным специалистом за 2 месяца</h1>
               <div class="blo1_tb">
                  <a class="btn" href="#price">Хочу на курс</a>
               </div>
            </div>
            <div class="blo1_s">
               <div class="blo1_ss lazy_img" data-src="/assets/img/bag/ыыы2.png"></div>
               <div class="blo1_sa">
                  <div class="blo1_sac">
                     <div class="blo1_sacp">Асем Женискызы <i class="fas fa-badge-check"></i></div>
               ...
               <div class="blo8_cip">
                  ...
                  <div class="blo8_cip_btn">
                     ...
                     <a class="btn btn_cl" href="<?=$whatsapp?>?text=<?=$wh_txt2?>" target="_blank">
                        <div class="kaspi_red_card lazy_img" data-src="/assets/img/card/новость-0-0-24.jpg"></div>
